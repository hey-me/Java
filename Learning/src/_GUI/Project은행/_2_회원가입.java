...
public class _2_회원가입 extends JFrame {
...
//	private Map<String, Customer> map = new HashMap<String, Customer>();
	...
	public _2_회원가입() {
		...
		nameLa.setBounds(100, 50, 100, 30);
		c.add(nameLa);
		nameTf.setFont(new Font("굴림", Font.BOLD, 15));
		nameTf.setBounds(200, 50, 100, 30);
		c.add(nameTf);
		...
		cancelBtn.setBounds(195, 350, 75, 30);
