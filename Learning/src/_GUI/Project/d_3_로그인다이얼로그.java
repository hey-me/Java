...
public class d_3_로그인다이얼로그 extends JDialog {
	...
	public d_3_로그인다이얼로그(JFrame frame, String title) {
		super(frame, title);
		setTitle("로그인");
		c.setLayout(null);
	...
	String login(String id, String password) {
		...
		if (id == null || password == null) {
			...
			File file = new File("C:/JavaSF/workspace/Project/다이어리/" + id + "," + password + "/사용자정보.txt");
			if (!file.exists()) {
				str = "없음";
